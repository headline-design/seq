...
export const ExportModal: React.FC<ExportModalProps> = ({
   ...
   const exportDuration =
      source === "all" ? totalDuration : selectionBounds ? selectionBounds.end - selectionBounds.start : totalDuration
               ...
               {downloadUrl ? (
                  ...
                  <div className="flex flex-col gap-4 py-6">
                     <div className="flex justify-between text-sm mb-1">
                        <span className="text-neutral-300">{isInitializing ? "Initializing Engine..." : "Rendering..."}</span>
                     ...
                     <div className="space-y-3">
                        ...
                        <div className="flex gap-3">
                           ...
                           <button
                              ...
                              className={`flex-1 py-3 px-4 rounded-lg border text-sm font-medium transition-all ${source === "selection" ? "bg-indigo-500/10 border-indigo-500" : "bg-neutral-900 border-neutral-800 text-neutral-400 hover:border-neutral-700"} ${!selectionBounds && "opacity-50 cursor-not-allowed"}`}
                           >
                              Selection
                           </button>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                           ...
                           >
                              ...
                              <div className="text-[10px] text-neutral-500 mt-1">
                                 1920x1080 • ~{(exportDuration * 1.5).toFixed(1)}MB
                              </div>
                           </button>
                           <button
                           ...
                           >
                              ...
                              <div className="text-[10px] text-neutral-500 mt-1">
                                 1280x720 • ~{(exportDuration * 0.8).toFixed(1)}MB
                              </div>
                           </button>
                        </div>
                     </div>
