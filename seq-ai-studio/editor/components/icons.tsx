...
export const LogoIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className={className}>
    <path
      fill="currentColor"
      d="M21.5 4H18l1.74 2.61c.11.17-.01.39-.21.39h-2c-.33 0-.65-.17-.83-.45L15 4h-2l1.74 2.61c.11.17-.01.39-.21.39h-2c-.33 0-.64-.17-.83-.45L10 4H8l1.74 2.61c.11.17-.01.39-.21.39h-2c-.33 0-.64-.17-.83-.45L5 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4.5c0-.28-.22-.5-.5-.5M11.25 15.25L10 18l-1.25-2.75L6 14l2.75-1.25L10 10l1.25 2.75L14 14z"
    />
  </svg>
)
...
export const MagnetIcon = ({ className }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <path d="m6 15-4-4 6.75-6.77a7.79 7.79 0 0 1 11 11L13 22l-4-4 6.39-6.39a4.5 4.5 0 0 0-6.36-6.36L2.6 11.66z" />
  </svg>
)
...
export const UndoIcon = ({ className }: IconProps) => (
  ...
  >
    <path d="M3 7v6h6" />
    <path d="M21 17a9 9 0 0 0-6.219-8.56" />
  </svg>
)
