...
function CrossDissolvePreview() {
  return (
    <div className="relative w-full h-full">
      ...
      <div
        className="absolute inset-0 bg-violet-500 animate-[pulse_2s_ease-in-out_infinite_0.5s]"
...
const TransitionCard = memo(function TransitionCard({
  ...
  return (
    ...
    >
      ...
      {/* Label */}
      <div className="p-2.5">
        <h4 className={`text-xs font-medium ${isSelected ? "text-indigo-300" : "text-neutral-300"}`}>
          {transition.label}
        </h4>
  ...
  return (
    <div className="flex flex-col gap-3 p-4 bg-neutral-900/50 rounded-lg border border-neutral-800">
      ...
      <input
        ...
        className="w-full h-1.5 bg-neutral-700 rounded-lg appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:bg-indigo-500 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:shadow-lg [&::-webkit-slider-thumb]:shadow-indigo-500/30"
      />
